...
<br></br>
<hr></hr>
<h1>Test Bean Message</h1>
<form action="<%=application.getContextPath()%>/testbean1" method="post">
	<p>
		Test String: <input type="text" name="message">
	</p>
	<input type="submit" value="Submit Test Bean Message">
</form>
</body>
</html>
